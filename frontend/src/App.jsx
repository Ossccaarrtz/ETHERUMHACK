  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(
        ...
        err.message || 
        'Failed to upload evidence. Ensure backend is running on port 3001.'
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium tracking-wide">BLOCKCHAIN EVIDENCE PLATFORM</p>
              </div>
            </div>
            <div className="hidden md:flex items-center space-x-2">
              <div className="badge bg-emerald-100 text-emerald-700 border border-emerald-200">
        ...
        <div className="glass-card p-8 md:p-12 animate-slide-up">
          {!mode && !result && (
            <div>
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold text-slate-900 mb-3">Submit Evidence</h2>
                <p className="text-slate-600 max-w-2xl mx-auto">
                  Record or upload video evidence that will be cryptographically verified and 
                  permanently stored on IPFS and Arbitrum/Scroll blockchains.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">Record Video</h3>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Capture live evidence directly from your device camera with instant verification.
                    </p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Select and upload existing video files from your device for blockchain verification.
                    </p>
                  </div>
                </button>
              </div>
          ...
          {mode === 'record' && !videoFile && (
            <div>
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl font-bold text-slate-900">Record Evidence</h2>
                  <p className="text-sm text-slate-600 mt-1">Capture video from your camera</p>
                </div>
                <button onClick={handleReset} className="p-2 hover:bg-slate-100 rounded-lg transition-colors">
            ...
            <div>
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">Select a video file from your device</p>
                </div>
                <button onClick={handleReset} className="p-2 hover:bg-slate-100 rounded-lg transition-colors">
                  <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
          ...
          {videoFile && !result && (
            <div>
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl font-bold text-slate-900">Submit to Blockchain</h2>
                  <p className="text-sm text-slate-600 mt-1">Complete the verification process</p>
                </div>
                <button onClick={handleReset} className="p-2 hover:bg-slate-100 rounded-lg transition-colors">
                  <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-5 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-slate-900 mb-1">{videoFile.name}</p>
                    <p className="text-sm text-slate-600">
                      {(videoFile.size / (1024 * 1024)).toFixed(2)} MB • Ready for upload
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-xs text-center text-slate-500 mt-4">
                Evidence will be hashed, uploaded to IPFS, and recorded on Arbitrum & Scroll testnets
              </p>
            </div>
          )}
