export default function ResultDisplay({ result }) {
  ...
  const copyToClipboard = (text, label) => {
    ...
    notification.className = 'fixed bottom-4 right-4 bg-slate-900 text-white px-4 py-3 rounded-lg shadow-lg z-50 animate-slide-up';
    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-8 text-white">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-emerald-100 text-sm">Successfully recorded on blockchain</p>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <p className="text-emerald-100 text-xs font-medium mb-1">Networks</p>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Cryptographic fingerprint</p>
            </div>
            <button
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5 hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-blue-600 mt-0.5">Distributed storage identifier</p>
            </div>
            <button
            ...
            <div className="bg-slate-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-slate-700">Arbitrum</span>
                </div>
                <button
                  onClick={() => copyToClipboard(result.arbitrumTx, 'Arbitrum TX')}
            ...
            <div className="bg-slate-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-slate-700">Scroll</span>
                </div>
                <button
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="text-sm font-medium text-amber-900 mb-1">Development Mode</p>
            <p className="text-xs text-amber-700 leading-relaxed">
              Blockchain transactions are currently using mock values. Once smart contracts are deployed on testnets, 
              real transaction hashes will be displayed and verifiable on block explorers.
            </p>
          </div>
        </div>
      </div>
